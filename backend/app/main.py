...
from app.api import documents, search, rag, conversations
...
app.include_router(conversations.router, prefix=f"{API_PREFIX}{API_V1_STR}/conversations", tags=["conversations"])
